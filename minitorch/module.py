...
class Module:
    ...
    def train(self) -> None:
        """Set the `training` flag of this and all descendents to true."""
        for m in self.modules():
            m.train()
        self.training = True

    def eval(self) -> None:
        """Set the `training` flag of this and all descendents to false."""
        for m in self.modules():
            m.eval()
        self.training = False
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        """What happens when the class gets invoked (?)"""
